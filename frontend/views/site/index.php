                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="slider-1">
                                    ...
                                    <p class="animated8">Template is designed for all types of businesses such as
                                        Corporate, Business, Portfolio, Creative, Blog, Agency and many more… </p>
...
<section class="page-section-ptb blue-bg">
    <div class="container">
        <div class="row">
...
<section class="custom-content-5 page-section-ptb">
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <img class="img-responsive mb-20" src="images/about/01.jpg" alt="">
                </div>
                <div class="col-lg-8 col-md-8">
                    ...
                    <div class="skills-2 mt-80">
                      ...
                      <span class="bar" data-bar='{ "color": "#ddbe86" }'>
                      ...
                      <span class="bar" data-bar='{ "color": "#ddbe86", "delay": "600" }'>
                        <span class="pct">90%</span>
                            ...
                            <li><h5> Javascript</h5>
                                <div class="bar_container">
                       <span class="bar" data-bar='{ "color": "#ddbe86", "delay": "1200" }'>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="section-title-2 text-center">
                    ...
                    <p>We provide the best service in the Web World</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="feature-15 text-center">
                        <div class="feature-15-icon">
...
<section class="portfolio-4 white-bg page-section-ptb">
    <div class="container">
        <div class="row">
            <div class="section-title-2 text-center">
                <h1 class="text-blue">Latest Projects</h1>
                <div class="title-line"></div>
                <p>We provide the best service in the Web World</p>
            </div>
        </div>
        <div class="isotope-filters-3">
        ...
        <div class="isotope popup-gallery popup-gallery columns-3">
            <div class="grid-item photography illustration">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/17.jpg" alt="">
            ...
            <div class="grid-item photography">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/18.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item photography branding">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/19.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item web-design">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/20.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item photography illustration">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/21.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item photography">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/22.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/23.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item photography branding">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/24.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
            ...
            <div class="grid-item illustration">
                <div class="portfolio-item">
                    <img src="images/portfolio/small/25.jpg" alt="">
                    <div class="portfolio-hover">
                        <div class="hover-name">
                            <span> With some description</span>
                            <a href="#">PHOTO ITEM</a>
...
<section class="custom-content-6 blue-bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 pull-right right-slide">
                <!--                TODO  fix the image-->
                <!--                <img src="images/about/13.jpg" style="" alt="">-->
            </div>
        </div>
    </div>
</section>
